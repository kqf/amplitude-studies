...
class MinuitMethod(object):
    ...
    def __call__(self, fun, x0, args, **kwargs):
        ...
        amin, edm, errdef = ROOT.Double(
            0.18), ROOT.Double(0.19), ROOT.Double(0.20)
        nvpar, nparx, icstat = ROOT.Long(
            1983), ROOT.Long(1984), ROOT.Long(1985)
        ...
        return OptimizeResult(nit=self.nit, success=success,
                              message=msg, x=optpar)
