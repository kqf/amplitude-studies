...
from amplitude import AnalyticAmplitude, NumericAmplitude
from amplitude import TripleExponentAmplitude, NonlinearAmplitude
...
class Eikonal(object):
    ...
    def A_amplitude(self, s, t, code, skipreal=True):
        ...
        def f(b):
            return self.H_amplitude(s, b, code).imag * b * sf.j0(b * t ** 0.5)
        ...
        def f(b):
            return self.H_amplitude(s, b, code).real * b * sf.j0(b * t ** 0.5)
